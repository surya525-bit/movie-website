            ...
            <ul class="navbar-nav">
              ...
              <div class='col' style='padding-left:175px;'>
                    <form action='search.php' method='POST' style='padding-top:10px;'>
                      <input type='text'  placeholder='search by name . .' style='color:white;margin-left:10px;padding:5px;background-color:#0D0D0D ;border-bottom: 1px solid #daa520;border-right: 1px solid #daa520;' name='textoption'>
                      <style>
::placeholder {
  ...
  opacity: 1; /* Firefox */
      ...
      <div class="jumbotron"style="background-color: #0D0D0D;margin-top:0px;margin-bottom:0px;border-radius:0px;border-top: 2px solid #daa520;">
        <h2 style='margin-top:0px;padding-top:0px;color:white;'>  PREMIUM MOVIES</h2>
          <?php
            include 'fetcher.php';
            ?>
      ...
      <div class="jumbotron"style="background-color: #0D0D0D;margin-top:0px;margin-bottom:0px;border-radius:0px;border-top: 2px solid #daa520;">
        <h2 style='margin-top:0px;padding-top:0px;color:white;'>  MOST VIEWED</h2>
          <?php
            include 'most-fetcher.php';
            ?>
